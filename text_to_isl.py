...
TARGET_SIZE = 100
MAX_CHARS_PER_LINE = 10  # max letters per line before wrapping
...
def pad_image_width(img, target_width):
    ...
    if w == target_width:
        return img
    # Create white padding on right side
...
def display_isl_word(text):
    ...
    h_concat_lines = []
    max_width = 0
    # First find max width after horizontal concat to pad all lines equally
